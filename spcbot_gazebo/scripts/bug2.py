...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        #rospy.loginfo("distance to line: [%.2f], state : [%.2f]",distance_to_line(position_),state_)
        if state_ == 0:
        ...
        rospy.loginfo("distance to line: [%.2f], position: [%.2f, %.2f],state : [%s]" ,distance_to_line(position_), position_.x, position_.y,state_desc_[state_])
        rate.sleep()
